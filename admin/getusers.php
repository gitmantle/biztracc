...
$grid->SelectCommand = "SELECT users.uid,users.ufname,users.ulname,users.uadmin,subscribers.subname from users,subscribers where users.sub_id = subscribers.subid";
...
$grid->setColProperty("subname", array("label"=>"Subscriber", "width"=>150));
