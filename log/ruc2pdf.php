...
while ($newpage == 'Y') {
	...
	$qruc = "select regno,ruclicence,sum(private) as distance from ruckms where claimed = 'No' group by ruclicence limit ".$offset.",10";
...
$q = "update ruckms set claimed = 'Yes' where claimed = 'No'";
$r = mysql_query($q) or die(mysql_error());
