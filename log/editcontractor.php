...
$rtid = $_REQUEST['uid'];
$q = "select * from contractors where uid = ".$rtid;
$r = mysql_query($q);
...
<form name="form1" id="form1" method="post" >
 ...
 <table width="500" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    ...
    <tr>
      ...
      <td><input name="contractor" type="text" id="contractor" size="50" value="<?php echo $contractor; ?>"></td>
      </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Crew</label></td>
      <td><input name="crew" type="text" id="crew" value="<?php echo $crew; ?>" ></td>
      </tr>
	<tr>
