...
<form name="form1" id="form1" method="post" >
 ...
 <table width="700" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td colspan="2" bgcolor="<?php echo $bghead; ?>" align="center"><label style="color: <?php echo $thfont; ?>"><strong>Add Hazard </strong></label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea name="hazard" id="hazard" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea name="action" id="action" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
...
<?php
	...
	if($_REQUEST['savebutton'] == "Y") {
		...
		$q = "insert into site_hazards (routeid,hazard,risk,strategy,action,local,management,ddate,harm,damage,reoccur) values (";
		$q .= $rid.',';
		$q .= '"'.$hazard.'",';
		$q .= '"'.$risk.'",';
		$q .= '"'.$strategy.'",';
