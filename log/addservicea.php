...
$query = "select uid,workshop from workshop";
...
$q = "select regno, make, cofdate from vehicles where vehicleno = '".$vn."'";
...
function post() {
	...
	if (nextdue == "") {
		alert("Please enter Kms when next A service due.");
		ok = "N";
		return false;
	}
...
<form name="form1" id="form1" method="post" >
 ...
 <table width="970" border="0" align="center" cellspacing="4" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td colspan="4" bgcolor="<?php echo $bghead; ?>" align="center"><label style="color: <?php echo $thfont; ?>"><strong> A Service for <?php echo $vn; ?></strong></label></td>
    </tr>
    <tr>
      ...
      <input type="Text" id="ddate" name="ddate" maxlength="25" size="25" value="<?php echo $ddate; ?>"><a href="javascript:NewCal('ddate')"><img src="../includes/datetimepick/cal.gif" width="16" height="16" border="0" alt="Pick a date"></td>
    </tr>
    <tr>
 ...
 <table width="970" border="0" align="center" cellspacing="4" bgcolor="<?php echo $bgcolor; ?>">
    ...
    <tr>
      <td class="boxlabelleft" bgcolor="#99FFFF">Engine oil level</td>
	...
	<tr>
      <td colspan="3" class="boxlabelleft">Serviceman
        <select name="serviceman" id="serviceman">
      </select>
        Next A Service due at Kms 
...
<?php
	...
	if($_REQUEST['savebutton'] == "Y") {
		...
		$q = "insert into service (vehicleno,date,hubodometer,speedo,jobno,workshop,service_type,servicedue) values ('".$vn."','".$ddate."',".$hubo.",".$speedo.",'".$jobno."','".$workshop."','A',".$nextdue.")";
		$r = mysql_query($q) or die(mysql_error().$q);
		$sid = mysql_insert_id();

		$q = "insert into servicea (service_id,workshop,jobno,ddate,hubo,speedo,check1,check2,check3,check4,check5,check6,check7,check8,grease1,grease2,grease3,grease4,grease5,grease6,grease7,grease8,chassis1,chassis2,chassis3,chassis4,chassis5,visual1,visual2,visual3,visual4,visual5,exhaust1,exhaust2,exhaust3,drive1,drive2,drive3,steering1,steering2,steering3,suspension1,suspension2,suspension3,suspension4,suspension5,suspension6,suspension7,air1,air2,air3,fuel1,fuel2,body1,body2,body3,body4,turn1,turn2,turn3,turn4,electric1,electric2,electric3,electric4,electric5,electric6,electric7,electric8,gen1,gen2,gen3,gen4,gen5,gen6,gen7,gen8,road1,comments,serviceman,servicedue) values (".$sid.",'".$workshop."','".$jobno."','".$ddate."',".$hubo.",".$speedo.",'".$check1."','".$check2."','".$check3."','".$check4."','".$check5."','".$check6."','".$check7."','".$check8."','".$grease1."','".$grease2."','".$grease3."','".$grease4."','".$grease5."','".$grease6."','".$grease7."','".$grease8."','".$chassis1."','".$chassis2."','".$chassis3."','".$chassis4."','".$chassis5."','".$visual1."','".$visual2."','".$visual3."','".$visual4."','".$visual5."','".$exhaust1."','".$exhaust2."','".$exhaust3."','".$drive1."','".$drive2."','".$drive3."','".$steering1."','".$steering2."','".$steering3."','".$suspension1."','".$suspension2."','".$suspension3."','".$suspension4."','".$suspension5."','".$suspension6."','".$suspension7."','".$air1."','".$air2."','".$air3."','".$fuel1."','".$fuel2."','".$body1."','".$body2."','".$body3."','".$body4."','".$turn1."','".$turn2."','".$turn3."','".$turn4."','".$electric1."','".$electric2."','".$electric3."','".$electric4."','".$electric5."','".$electric6."','".$electric7."','".$electric8."','".$gen1."','".$gen2."','".$gen3."','".$gen4."','".$gen5."','".$gen6."','".$gen7."','".$gen8."','".$road1."','".$comments."','".$serviceman."','".$nextdue."')";

		$r = mysql_query($q) or die(mysql_error().$q);
		
		$q = "update vehicles set lastserviced = '".$ddate."', servicedue = ".$nextdue." where vehicleno = '".$vn."'";
		$r = mysql_query($q) or die(mysql_error().$q);
