...
<form name="form1" id="form1" method="post" >
 ...
 <table width="690" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td colspan="2" bgcolor="<?php echo $bghead; ?>" align="center"><label style="color: <?php echo $thfont; ?>"><strong>Add Damage to Property </strong></label></td>
    </tr>
    <tr>
      <td class="boxlabelleft"><label style="color: <?php echo $tdfont; ?>">Property</label></td>
      <td><input name="property" type="text" id="property" size="50" ></td>
      </tr>
    <tr>
      <td class="boxlabelleft"><label style="color: <?php echo $tdfont; ?>">Damage</label></td>
      <td><input name="damage" type="text" id="damage" size="50" ></td>
      </tr>
	<tr>
