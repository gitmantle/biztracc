...
$rtid = $_REQUEST['uid'];
$q = "select * from destinations where uid = ".$rtid;
$r = mysql_query($q);
...
<form name="form1" id="form1" method="post" >
 ...
 <table width="700" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td  bgcolor="<?php echo $bghead; ?>" align="center"><label style="color: <?php echo $thfont; ?>"><strong>Edit Destination </strong></label></td>
    </tr>
    <tr>
      <td colspan="2" class="boxlabelleft"><label style="color: <?php echo $tdfont; ?>">Destination</label>
        <input name="destination" type="text" id="destination" size="100" value="<?php echo $destination; ?>" ></td>
      </tr>
	<tr>
      <td align="right" >
