...
$pdf->AliasNbPages();
	...
	$risk = $hd * $c;
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(80,4,"Details of Incident: from site",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(80,4,"Details of Incident: from Administration",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->MultiCell(250,4,$adetails,0,"L",0);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','B',12);
		$pdf->Cell(80,4,"Immediate Causes: from site",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','B',12);
		$pdf->Cell(80,4,"Immediate Causes: Additions by Administration",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->MultiCell(250,4,$aimmediate,0,"L",0);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','B',12);
		$pdf->Cell(80,4,"Basic Causes: from site",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','B',12);
		$pdf->Cell(80,4,"Basic Causes: from Administration",0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic1,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic2,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic3,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic4,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic5,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic6,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic7,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		$pdf->SetFillColor(255,255,255);
		$pdf->SetFont('Arial','',12);
		$pdf->Cell(180,4,$abasic8,0,0,"L",1);
		$pdf->SetTextColor(0,0,0);
		...
		while ($row = mysql_fetch_array($rdam)) {
			...
			$pdf->SetFillColor(255,255,255);
			$pdf->SetFont('Arial','',12);
			$pdf->MultiCell(90,4,$damage,0,"L",0);
			$pdf->SetTextColor(0,0,0);
		}
		...
		while ($row = mysql_fetch_array($ract)) {
			...
			$pdf->SetFillColor(255,255,255);
			$pdf->SetFont('Arial','',10);
			$pdf->MultiCell(140,4,$action,0,"L",0);
			$pdf->SetTextColor(0,0,0);
		...
		while ($row = mysql_fetch_array($rp)) {
			...
			$this_image = "ws/incidents/".$picture;
