...
$attach = 'hazards/Hazard_'.$hazid.'_'.$subscriber.'.pdf';
...
$q = "select * from routes where uid = ".$hazid;
$r = mysql_query($q) or die(mysql_error().$q);
$qrow = mysql_fetch_array($r);
extract($qrow);
$subject = $_SESSION['s_coyname'].' Hazards on route '.$uid.' - '.$route;
$mess = "Attached please find completed site specific hazard report for ".$subject;
