...
<br>
  ...
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Profitability Report Parameters</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" class="boxlabelleft" valign="middle"><p>hold Ctrl while selecting to select multiple branches.</p>
      <p>&nbsp;</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" value="Run" name="run"  onClick="profitability()" ></td>
  </tr>
  </table>
</form>
</body>
