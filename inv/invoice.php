...
function emailtrading(type,rf) {
	...
	x = window.screenX +5;
	y = window.screenY +10;
	window.open('../fin/PrintTrading.php?type='+type+'&tradingref='+rf+'&doemail=Y'+'&noscreen=Y'+'&bcc='+bcc,'tipdf','toolbar=0,scrollbars=1,height=10,width=10,resizable=0,left='+x+',screenX='+x+',top='+y+',screenY='+y);
}		
...
function tojob() {
	var acct = document.getElementById('DRaccount').value;
	var email = document.getElementById('temail').value;
	if (acct == "" || email == "") {
		alert("Please enter a client and their email address.");
		...
		var address = document.getElementById('tadd').value;
		var phone = document.getElementById('tphone').value;
		// if no client account number, add client to database and xref as debtor
		if (account == '') {
			$.get("ajaxaddclient.php", {clname: acct, clemail: email, phone: phone, address: address}, function(data){
				var clientdata = data;	
				var cd = clientdata.split('***');
				var m = cd[0];
				var ph = cd[1];
				var em = cd[2];
				var ad = cd[3];
...
function topay() {
	...
	var st3 = document.getElementById('st3').value;
	var st4 = document.getElementById('st4').value;
	var it1 = document.getElementById('titem1').value;
	var it2 = document.getElementById('titem2').value;
	var it3 = document.getElementById('titem3').value;
	var it4 = document.getElementById('titem4').value;
	if (it1 == "" && it2 == "" && it3 == "" && it4 == "") {
		alert("Please enter at least one item.");
		document.getElementById('client').style.visibility = 'hidden';
		document.getElementById('job').style.visibility = 'visible';
		...
		if (it1 != "" && st1 == "") {
			$.get("ajaxaddstock.php", {stitem: it1}, function(data){
				document.getElementById('st1').value = data;
			});
		}
		if (it2 != "" && st2 == "") {
			$.get("ajaxaddstock.php", {stitem: it2}, function(data){
				document.getElementById('st2').value = data;
			});
		}
		if (it3 != "" && st3 == "") {
			$.get("ajaxaddstock.php", {stitem: it3}, function(data){
				document.getElementById('st3').value = data;
			});
		}
		if (it4 != "" && st4 == "") {
			$.get("ajaxaddstock.php", {stitem: it4}, function(data){
				document.getElementById('st4').value = data;
			});
		}
		document.getElementById('client').style.visibility = 'hidden';
		document.getElementById('job').style.visibility = 'hidden';
...
<div class="container-fluid">
      <div class="row">
        ...
        <div class="span9">
        	...
        	<button class="btn btn-xs btn-primary" type="button" onClick="transvisibledr()">Search</button>
       </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="span9">
			<input type="text" name="tadd" id="tadd" placeholder="No, Street, Suburb, Town" />
       </div>
      <div class="row">
        <div class="span3">
        	&nbsp;
        ...
        <div class="span3">
        	<button class="btn btn-xs btn-primary btn pull-right" type="button" onClick="tojob()">Next</button>
       </div>
        <div class="span3">
        	&nbsp;
        </div>
...
<div class="container">
      <div class="row">
        <div class="span3">
        	...
        	<button class="btn btn-xs btn-primary" type="button" onClick="stkvisible(1)">Search</button>
       </div>
        <div class="span6">
      ...
      <div class="row">
        <div class="span3">
        	...
        	<button class="btn btn-xs btn-primary" type="button" onClick="stkvisible(2)">Search</button>
       </div>
        <div class="span6">
      ...
      <div class="row">
        <div class="span3">
        	...
        	<button class="btn btn-xs btn-primary" type="button" onClick="stkvisible(3)">Search</button>
       </div>
        <div class="span6">
      ...
      <div class="row">
        <div class="span3">
        	...
        	<button class="btn btn-xs btn-primary" type="button" onClick="stkvisible(4)">Search</button>
       </div>
        <div class="span6">
      ...
      <div class="row">
        <div class="span6">
        	<button class="btn btn-xs btn-primary btn" type="button" onClick="toclient()">Back</button>
        	<button class="btn btn-xs btn-primary btn pull-right" type="button" onClick="topay()">Next</button>
        </div>
        <div class="span3">
          &nbsp;
       </div>
...
<div class="container">
      ...
      <div class="row">
        <div class="span3">
        	<button class="btn btn-xs btn-primary" type="button" onClick="tojob()">Back</button>
      	</div>
        <div class="span9">
        	<button class="btn btn-xs btn-primary" type="button" onClick="inv()">Create Invoice</button>
        	<button class="btn btn-xs btn-primary btn pull-right" type="button" onClick="pay()">Pay Now</button>
        </div>
      </div>
...
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
  ...
  <div id="stkselect2" style="position:absolute;visibility:hidden;top:70px;left:20px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
  ...
  <div id="stkselect3" style="position:absolute;visibility:hidden;top:130px;left:20px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
  ...
  <div id="stkselect4" style="position:absolute;visibility:hidden;top:180px;left:20px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
