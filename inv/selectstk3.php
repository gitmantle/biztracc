...
if($st_mask!='') {
	$where = " and upper(item) LIKE '".$st_mask."%'"; 
}
...
{
    if(rowid != null) {
	var rowdata = $("#selectstklist3").getRowData(rowid);
...
// Run the script
$grid->renderGrid('#selectstklist3','#selectstkpager3',true, null, null, true,true);
