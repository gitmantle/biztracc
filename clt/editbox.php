...
$query = "select * from boxes where box_id = ".$induid;
...
<title>Edit NZ Box Post Code</title>
...
<form name="form1" method="post" >
  <table width="400" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center" class="style1"><u>Edit NZ Box Post code </u></div></td>
    </tr>
    <tr>
      <td class="boxlabel">Post Office</td>
      <td><input type="text" name="postoffice" id="postoffice" value="<?php echo $post_office; ?>"></td>
    </tr>
    <tr>
...
<?php
	...
	if(isset($_POST['save'])) {
		...
		if ($_REQUEST['postoffice'] == '') {
			echo '<script>';
			echo 'alert("Please enter a post office.")';
			echo '</script>';	
			$ok = 'N';
		}
		if ($_REQUEST['city'] == '') {
		...
		if ($ok == 'Y') {	
				...
				$oBx->uid = $induid;
				$oBx->postoffice = $_REQUEST['postoffice'];
