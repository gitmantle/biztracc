...
<title>Add NZ Box Post Code</title>
...
<form name="form1" method="post" >
  <table width="400" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center" class="style1"><u>Add NZ Box Post Code </u></div></td>
    </tr>
    <tr>
      <td class="boxlabel">Post Office</td>
      <td><input type="text" name="postoffice" id="postoffice"></td>
    </tr>
    <tr>
