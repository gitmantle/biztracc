...
<form name="form1" id="form1" method="post" >
  ...
  <table width="950" border="0" align="center" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td colspan="6" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>;font-size:18px;">Add a Complaint</label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><select name="lsource" id="lsource">
          <option value="Client">Client</option>
          <option value="Lawyer">Lawyer</option>
          <option value="Other">Other</option>
        </select></td>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Nature of Complaint</label></td>
      <td align="left"><select name="lnature" id="lnature">
          <?php echo $nature_options;?>
        </select></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Complainant</label></td>
      <td colspan="3" align="left"><input name="tcomplainant" type="text" id="tcomplainant" size="50" maxlength="50">
        <img src="../images/Search.gif" width="16" height="16" alt="Search" onclick="findcomplainant()"></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Complaint Against</label></td>
      <td colspan="3" align="left"><input name="tagainst" type="text" id="tagainst" size="50" maxlength="50"></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Complaint Taken By</label></td>
      <td colspan="3" align="left"><input name="ttaken" type="text" id="ttaken" size="50" maxlength="50"></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Complaint Details</label></td>
      <td colspan="3" align="left"><textarea name="tdetails" id="tdetails" cols="90" rows="3"></textarea></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Outcome Sought by Complainant</label></td>
      <td colspan="3" align="left"><textarea name="toutcome" id="toutcome" cols="90" rows="3"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" align="left"><textarea name="tnotes" id="tnotes" cols="90" rows="3"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" align="left"><input type="text" name="tcompensation" id="tcompensation" value="0"></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Further Action Details (if applicable)</label></td>
      <td colspan="3" align="left"><textarea name="tfurther" id="tfurther" cols="90" rows="3"></textarea></td>
    </tr>
    <tr>
      <td class="boxlabel"><label style="color: <?php echo $tdfont; ?>">Root Cause</label></td>
      <td align="left"><input name="tcause" type="text" id="tcause" size="50" maxlength="50"></td>
...
<?php
	...
	if($_REQUEST['savebutton'] == "Y") {
	  $mid = $_REQUEST['mid'];
	  $comp = $_REQUEST['tcomplainant'];
	  $memid = $_REQUEST['mid'];
	  $agin = $_REQUEST['tagainst'];
	  $rec = $_REQUEST['recdate'];
	  $ack = $_REQUEST['ackdate'];
	  if ($ack == "" || $ack == "0000-00-00") {
		  $ack = 'N';
	  }
	  $cls = $_REQUEST['closedate'];
	  if ($cls == "" || $ack == "0000-00-00") {
		  $cls = 'N';
	  }
	...
	$db = new DBClass();
	  ...
	  $db->query('insert into '.$cltdb.'.complaints (member_id,complainant,against,received,acknowledged,closed,compensation,medium,source,nature,taken_by,details,outcome,notes,responded,cause,further_action,sub_id) values (:member_id,:complainant,:against,:received,:acknowledged,:closed,:compensation,:medium,:source,:nature,:taken_by,:details,:outcome,:notes,:responded,:cause,:further_action,:sub_id)');
	  $db->bind(':member_id', $mid);
	  $db->bind(':complainant', $comp);
	  $db->bind(':against', $agin);
	  $db->bind(':received', $rec);
