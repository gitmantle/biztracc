...
$grid->SelectCommand = "select addresses.address_id,addresses.location,addresses.street_no,addresses.ad1,addresses.ad2,addresses.suburb,addresses.town,addresses.state,addresses.postcode,address_type.address_type,addresses.billing,addresses.delivery from ".$cltdb.".addresses,".$cltdb.".address_type where addresses.address_type_id = address_type.address_type_id and addresses.member_id = ".$id; 
...
$grid->setColProperty("billing", array("label"=>"Billing", "width"=>55));
$grid->setColProperty("delivery", array("label"=>"Delivery", "width"=>55));
