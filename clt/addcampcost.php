...
<form name="form1" id="form1" method="post" >
 <input type="hidden" name="savebutton" id="savebutton" value="N">
  <table width="570" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center" class="style1"><u>Add Campaign Cost for <?php echo $name; ?></u></div></td>
    </tr>
    <tr>
      <td width="106" class="boxlabel"><div align="right">Item</div></td>
      <td><input name="item" type="text" id="item"  size="45" maxlength="45"></td>
      </tr>
    <tr>
