...
var bmenuItems = [
    ["General","javascript:switchDivm('mgeneral','ge');", "", "", "", "", "1", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Communications","javascript:switchDivm('mcommunications','co');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Addresses","javascript:switchDivm('maddresses','ad');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Quotes","javascript:switchDivm('mquotes','qt');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Workflow","javascript:switchDivm('mworkflow','wf');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Notes","javascript:switchDivm('mactivities','ac');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Documents","javascript:switchDivm('mdocuments','dc');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Emails","javascript:switchDivm('memails','el');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Complaints","javascript:switchDivm('mcomplaints','cc');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Accounting Categories","javascript:switchDivm('macats','at');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Financials","javascript:switchDivm('mfinancials','fn');", "", "", "", "", "2", "", "", ],
];
