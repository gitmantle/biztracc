...
$q = "select incid,subid,coyid from ".$incfile." where uid = ".$actid;
...
$q = "select * from incactions where uid = ".$actid;
...
<form name="form1" id="form1" method="post" >
 ...
 <table width="690" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td colspan="2" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>;font-size:14px"><strong>Edit an Action to be taken to prevent reoccurence</strong></label></td>
    </tr>
    <tr>
      <td class="boxlabelleft"><label style="color: <?php echo $tdfont; ?>">Action to be undertaken</label></td>
      <td class="boxlabelleft"><textarea name="action" id="action" cols="50" rows="5"><?php echo $iaction; ?></textarea></td>
    </tr>
    <tr>
