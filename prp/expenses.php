...
$db->query("select accountno,branch,sub,account from ".$findb.".glmast where accountno = 480 and blocked = 'N' and branch > '1001' order by branch,sub");
$rows = $db->resultset();
foreach ($rows as $row) {
	extract($row);
...
foreach ($rows as $row) {
	extract($row);
	$id = $uid;
	if ($account == 'REPAIRS AND MAINTENANCE') {
...
<div class="container-fluid">
    <section class="container">
		<div class="container-page">				
			<div class="col-md-12">
				<h3 class="dark-grey">Expenses Paid</h3>
				...
				<div class="form-group col-sm-4">
					<label>Expense paid for property</label>
                </div>
