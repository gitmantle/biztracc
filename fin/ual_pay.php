...
<title>Unallocate Payments</title>
...
<form name="inv" id="inv" method="post" >
  ...
  <table  width="960" border="0" cellpadding="3" cellspacing="1" align="center" bgcolor="<?php echo $bgcolor; ?>">
    <tr bgcolor="<?php echo $bghead; ?>">
      <td colspan="10"><label style="color: <?php echo $thfont; ?>"><strong>Unallocate allocated payments</strong></label></td>
    </tr>
    <tr>
      ...
      <td width="538" colspan="6" class="boxlabelleft" ><input type="button" name="ballocate" id="ballocate" value="List allocations against Goods Received" onClick="revalloc('pay')"></td>
    </tr>
  </table>
  ...
  <table  width="960" border="0" cellpadding="3" cellspacing="1" align="center" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td><?php include "getallocgrns.php"; ?></td>
    </tr>
  ...
  <div id="crselect" style="position:absolute;visibility:hidden;top:98px;left:342px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      ...
      <tr>
        <td colspan="2"><?php include "selectpayunallocate.php"; ?></td>
      </tr>
    </table>
  </div>
  ...
  <div id="unpaypart" style="position:absolute;visibility:hidden;top:250px;left:500px;height:75px;width:250px;background-color:<?php echo $bgcolor; ?>;border-width:7px; border-color:<?php echo $bghead; ?>; border-style:outset;">
    ...
    <tr>
      ...
      <td align="right"><input type="button" name="pamount" id="pamount" value="Save" onClick="ulpayment('pay')"></td>
    </tr>
    </table>
