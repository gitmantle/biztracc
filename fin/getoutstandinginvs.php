...
$where = "where accountno = ".$ac." and sub = ".$sb." and ((cash+cheque+eftpos+ccard+valreturned) < (totvalue + tax)) and (transtype = 'INV' or transtype = 'SAL')"; 
...
$grid->setUrl('getoutstandinginvs.php');
...
$grid->setColProperty("ref_no", array("label"=>"Reference", "width"=>60));
$grid->setColProperty("gldesc", array("label"=>"Description", "width"=>100));
$grid->setColProperty("totvalue", array("label"=>"Value", "width"=>60, "align"=>"right","formatter"=>"number"));
$grid->setColProperty("tax", array("label"=>"Tax", "width"=>60, "align"=>"right","formatter"=>"number"));
$grid->setColProperty("total", array("label"=>"Total", "width"=>75, "align"=>"right","formatter"=>"number"));
$grid->setColProperty("paid", array("label"=>"Paid", "width"=>70, "align"=>"right","formatter"=>"number"));
$grid->setColProperty("valreturned", array("label"=>"Returns", "width"=>70, "align"=>"right","formatter"=>"number"));
$grid->setColProperty("outstanding", array("label"=>"Outstanding", "width"=>75, "align"=>"right","formatter"=>"number"));
...
{
    if(rowid != null) {
		var rowd = $("#outinvlist").getRowData(rowid);
		var ref = rowd.ref_no;
...
function(rowid, selected)
{
   ...
   jQuery("#outinvlist").jqGrid('clearGridData',true);
}
CLEAR;
...
// Run the script
$grid->renderGrid('#outinvlist','#outinvpager2',true, null, null, true,true);
