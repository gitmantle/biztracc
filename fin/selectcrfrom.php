...
$heading = 'Select Starting Credtor Ledger Account';
...
$grid->SelectCommand = "select account,accountno,sub from ".$findb.".".$crfile;
...
// Run the script
$grid->renderGrid('#selectcrfromlist','#selectcrfrompager',true, null, null, true,true);
