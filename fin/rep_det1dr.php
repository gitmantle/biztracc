...
<title>Detail One Debtor Parameters</title>
...
<br>
  ...
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Detail One Debtor Parameters</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4"><input type="text" name="DRaccount" id="DRaccount" size="45" readonly="readonly" />
      <img src="../images/Search.gif" width="16" height="16" alt="Lookup" id="glsearch" onclick="get1dr()" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" value="Run" name="run"  onClick="det1dr()" ></td>
  </tr>
  </table>
