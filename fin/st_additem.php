...
<form name="form1" id="form1" method="post" >
 ...
 <input type="hidden" name="stkstock" id="stkstock" value="Stock">
  <table width="1180" border="0" align="center">
    ...
    <tr>
      ...
      <td><input type="text" name="stkunit" id="stkunit"></td>
    ...
    <tr>
      <td class="boxlabel">Edit this stock item to add its image.</td>
      <td rowspan="2">&nbsp;</td>
      <td class="boxlabel">Technical Notes</td>
      <td colspan="3"><textarea name="technotes" id="technotes" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td class="boxlabel">&nbsp;</td>
      <td class="boxlabel">Advertising Text</td>
      <td colspan="3"><textarea name="advert" id="advert" cols="45" rows="5"></textarea></td>
    </tr>
	  <td>&nbsp;</td>
