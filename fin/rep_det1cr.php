...
<title>Detail One Creditor Parameters</title>
...
<form name="form1" method="post" >
	 <input type="hidden" name="det1" id="det1" value="cr">
<br>
  <table width="700" border="0" align="center" cellpadding="3">
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Detail One Creditor Parameters</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4"><input type="text" name="CRaccount" id="CRaccount" size="45" readonly="readonly" />
      <img src="../images/Search.gif" width="16" height="16" alt="Lookup" id="glsearch" onclick="get1cr()" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" value="Run" name="run"  onClick="det1cr()" ></td>
  </tr>
  </table>
