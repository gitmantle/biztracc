...
$where = ' where '.$findb.'.stkmast.deftax = '.$findb.'.taxtypes.uid';
if($cr_mask!='') {
	$where .= " and upper(".$findb.".stkmast.item) LIKE '".$cr_mask."%'"; 
}
...
$grid->SelectCommand = "select ".$findb.".stkmast.itemcode,".$findb.".stkmast.item,".$findb.".stkmast.unit,".$findb.".stkmast.deftax,".$findb.".taxtypes.taxpcent,".$findb.".stkmast.sellacc,".$findb.".stkmast.sellbr,".$findb.".stkmast.sellsub,".$findb.".stkmast.purchacc,".$findb.".stkmast.purchbr,".$findb.".stkmast.purchsub,".$findb.".stkmast.groupid,".$findb.".stkmast.catid,".$findb.".stkmast.avgcost,".$findb.".stkmast.setsell,".$findb.".stkmast.trackserial,".$findb.".stkmast.stock from ".$findb.".stkmast,".$findb.".taxtypes".$where;
...
$grid->setColProperty("stock", array("label"=>"Type", "width"=>50));
...
function(rowid, selected)
{
	...
	var stk = stkcode+'~'+stkname+'~'+stkunit+'~'+stax+'~'+sac+'~'+sbr+'~'+ssb+'~'+pac+'~'+pbr+'~'+psb+'~'+group+'~'+cat+'~'+cost+'~'+setsell+'~'+trackserial+'~'+staxpcent+'~'+stock;
	setstkselect(stk);	
    }
}
ACC;
