...
$q = "select asset from fixassets where accountno = ".$ac." and branch = '".$br."' and sub = ".$sb;
...
$heading = $ass." - ".$branchname." - ".$ac." - between '".$fromdate."' and '".$todate."'";
