...
<form name="inv" id="inv" method="post" >
  ...
  <table  width="960" border="0" cellpadding="3" cellspacing="1" align="center" bgcolor="<?php echo $bgcolor; ?>">
    <tr bgcolor="<?php echo $bghead; ?>">
      <td colspan="10"><label style="color: <?php echo $thfont; ?>"><strong>Allocate unallocated payments</strong></label></td>
    </tr>
    <tr>
  ...
  <table  width="960" border="0" cellpadding="3" cellspacing="1" align="center" bgcolor="<?php echo $bgcolor; ?>">
    <tr >
      <td>&nbsp;</td>
      <td><input type="button" name="ballocate" id="ballocate" value="Allocate against Goods Received" onClick="allocunalloc('pay')"></td>
      <td class="boxlabel" >Unallocated</td>
      <td><input type="text" name="unallocated" id="unallocated" readonly></td>
      </tr>
    <tr>
      <td colspan="4"><?php include "getoutstandinggrns.php"; ?></td>
    </tr>
    <tr>
      <td colspan="4"><?php include "getgrnlines.php"; ?></td>
    </tr>
  ...
  <div id="crselect" style="position:absolute;visibility:hidden;top:98px;left:342px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      ...
      <tr>
        <td colspan="2"><?php include "selectpayallocate.php"; ?></td>
      </tr>
    </table>
  </div>
