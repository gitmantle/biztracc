...
<form name="stdtrans" id="stdtrans" method="post" >
  ...
  <table width="950" border="0" cellpadding="3" cellspacing="1" align="center" bgcolor="<?php echo $bgcolor; ?>">
    ...
    <tr>
      ...
      <td width="151"><select name="ref" id="newref" >
          <option value="NSS" selected>Non-Stock Sale</option>
        </select></td>
      <td width="165"><input name="refno" type="text" id="newrefno" size="10" readonly onFocus="nexttrdref_ns('nss')"></td>
    </tr>
    <tr bgcolor="#CCCCCC">
      <td class="boxlabel" ><label style="color:#000000;">Allocate Sale to</label></td>
      ...
      <td><div align="left">
          <select name="bgacc2cr" id="newbgacc2cr" onchange="ajaxGetACList_ns(this.value,'dns'); return false;">
    ...
    <tr bgcolor="#FF9933">
      <td class="boxlabel"><label style="color:#000000;">Pay into Account</label></td>
      <td colspan="3"><div align="left">
      ...
      <td><div align="left">
          <select name="bgacc2dr" id="newbgacc2dr" onchange="ajaxGetACList_ns(this.value,'bns'); return false;">
            <option value="GL" selected>General Ledger</option>
          </select>
        </div></td>
  ...
  <div id="drselect" style="position:absolute;visibility:hidden;top:104px;left:455px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
        <td><input type="text" id="searchdr" size="50" onkeypress="doSearchglns()" /></td>
        <td align="right"><img src="../images/close.png" width="16" height="16" alt="Lookup" id="glclose" onclick="sboxhideglns()">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><?php include "selectbdnsp.php"; ?></td>
      </tr>
    </table>
  </div>
  ...
  <div id="crselect" style="position:absolute;visibility:hidden;top:104px;left:455px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
        ...
        <td align="right"><img src="../images/close.png" width="16" height="16" alt="Lookup" id="crclose" onclick="sboxhidecrns()">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><?php include "selectcnsp.php"; ?></td>
      </tr>
    </table>
  </div>
