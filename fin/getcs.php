...
$grid->SelectCommand = "select uid,ref_no,client,ddate,totvalue,tax from ".$findb.".invhead where transtype = 'C_S'";
...
// Run the script
$grid->renderGrid('#cs','#cspager',true, null, null, true,true);
