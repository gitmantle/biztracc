...
<title>Detail One GL Account Parameters</title>
...
<br>
  ...
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Detail One GL Account Parameters</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" value="Run" name="run"  onClick="det1gl()" ></td>
  </tr>
  </table>
