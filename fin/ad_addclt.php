...
function post() {
	...
	if ((commtype == 0 || comm == "") && (streetno == "" || street == "" || town == "")) {
  ...
  <div id="hbot42" style="position:absolute;visibility:visible;top:175px;left:1px;height:275px;width:970px;border-width:thin thin thin thin; background-color: <?php echo $bgcolor; ?>;  border-color:#999; border-style:solid;">
    ...
    <table width="480" border="0" align="right">
      ...
      <tr>
        ...
        <td><input name="mstreetno" type="text" id="mstreetno" size="50" onfocus="this.select();"></td>
      </tr>
      <tr>
        <td class="boxlabel">Street</td>
        <td><input name="mstreet" type="text" id="mstreet" onfocus="this.select();"  size="50"></td>
      </tr>
      <tr>
        <td class="boxlabel">Suburb</td>
        <td><input name="msuburb" type="text" id="msuburb" size="50" onfocus="this.select();"></td>
      </tr>
      <tr>
        <td class="boxlabel">Town</td>
        <td><input name="mtown" type="text" id="mtown" size="50" onfocus="this.select();"></td>
      </tr>
      <tr>
        <td class="boxlabel">Post Code</td>
        <td><input name="mpostcode" type="text" id="mpostcode" size="50"></td>
      </tr>
      <tr>
...
<?php
	if($_REQUEST['savebutton'] == "Y") {
		...
		$oCn->status = $_REQUEST['status'];
		$oCn->billadd = $_REQUEST['billadd'];
		$oCn->deladd = $_REQUEST['deladd'];
		...
		$db->bind(':action', 'Added member id '.$cluid);																							  
																									  
		$db->execute();		

		echo '<script>';
		if ($ledger == 'c') {
			echo 'window.open("","ad_updtcr").jQuery("#cltlistcr").trigger("reloadGrid");';
		} else {
			echo 'window.open("","ad_updtdr").jQuery("#cltlistdr").trigger("reloadGrid");';
		}
		echo 'this.close();';
		echo '</script>;';
