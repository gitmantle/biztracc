...
$db->query("select h.ddate, h.client, i.ref_no, i.item, i.quantity, i.unit, i.value from ".$findb.".invtrans i, ".$findb.".invhead h, ".$findb.".stkmast s where (i.ref_no = h.ref_no) and (i.itemcode = s.itemcode) and (s.stock = 'Service') and (h.ddate >= '".$bdt."' and h.ddate <= '".$edt."') and i.itemcode = '".$nstk."'");
$rows = $db->resultset();
