...
$grid->SelectCommand = "select distinct users.uid,users.ufname,users.ulname,users.uemail,users.uphone,users.umobile,access.branch from users,access where users.uid = access.staff_id and users.sub_id = ".$sid." and access.module = 'fin'";
