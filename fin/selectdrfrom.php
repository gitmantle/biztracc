...
$heading = 'Select Starting Debtor Ledger Account';
...
$grid->SelectCommand = "select account,accountno,sub from ".$findb.".".$drfile;
...
// Run the script
$grid->renderGrid('#selectdrfromlist','#selectdrfrompager',true, null, null, true,true);
