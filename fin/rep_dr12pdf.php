...
$db->query("select concat(members.firstname,' ',members.lastname) as cname from ".$cltdb.".members,".$cltdb.".client_company_xref where client_company_xref.drno = ".$ac." and client_company_xref.drsub = ".$sb." and members.member_id = client_company_xref.client_id");
$row = $db->single();
extract($row);
$acc = $account;
