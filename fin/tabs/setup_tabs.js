...
var bmenuItems = [
    ["Company Details","javascript:switchDivm('details','ge');", "", "", "", "", "1", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Trading Tax - GST/VAT","javascript:switchDivm('gst','co');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Accounting Dates","javascript:switchDivm('dates','ad');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Document Reference Numbers","javascript:switchDivm('referencenos','wf');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Trading Parameters","javascript:switchDivm('stock','ac');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Recurring Transaction Files","javascript:switchDivm('recurring','el');", "", "", "", "", "2", "", "", ],
];
