...
var bmenuItems = [
    ["System","javascript:switchDivm('system','hd');", "", "", "", "", "1", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Boxes","javascript:switchDivm('boxes','dt');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Labels","javascript:switchDivm('labels','ft');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Data Grid","javascript:switchDivm('grid','rm');", "", "", "", "", "2", "", "", ],
];
