...
<title>Trial Balance Parameters</title>
...
<br>
  ...
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Trial Balance Parameters</label></td>
  </tr>
  <tr>
    <td class="boxlabelleft"><input type="radio" name="dates" id="dates" onclick="displayResult(this.value)" value="ytd" checked>Year to Date</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td class="boxlabelleft"><input type="radio" name="dates" id="dates" onclick="displayResult(this.value)" value="between">Between Dates</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="2" class="boxlabelleft">Include accounts with zero balances</td>
    <td colspan="3" ><input type="checkbox" name="zerobal" id="zerobal" /></td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
   	<td>&nbsp;</td>
   	<td>&nbsp;</td>
 	<td colspan="2"><input type="button" value="Run" name="run"  onClick="tb()" ></td>
  </tr>
  </table>
