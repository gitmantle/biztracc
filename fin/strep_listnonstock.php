...
<title>Non Stock Item List</title>
...
function tst2xl() {
	...
	//var filterCriteria = $("#nstklist").jqGrid('getGridParam', 'postData');	
	window.open('nonstk2excel.php','ns2xl','toolbar=0,scrollbars=1,height=670,width=950,resizable=0,left='+x+',screenX='+x+',top='+y+',screenY='+y);
}
...
<body>
  <table width="850" border="0" align="center">
    <tr>
      <td><?php include "getNonStocklist.php"; ?></td>
    </tr>
    <tr>
