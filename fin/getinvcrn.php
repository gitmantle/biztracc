...
$grid->SelectCommand = "select uid,ref_no,client,ddate,totvalue,tax from ".$findb.".invhead where transtype = 'INV' or transtype = 'CRN'";
...
{
    if(rowid != null) {
		var rowd = $("#invcrnlist").getRowData(rowid);
		var rno = rowd.ref_no;
...
// Run the script
$grid->renderGrid('#invcrnlist','#invcrnpager',true, null, null, true,true);
