...
<title>Detail Multiple DR Account Parameters</title>
...
<br>
  ...
  <tr>
  	<td colspan="5" align="center" bgcolor="<?php echo $bghead; ?>"><label style="color: <?php echo $thfont; ?>; font-size:14px;">Detail Multiple Debtor Account Parameters</label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4"><input type="text" name="DRaccount" id="DRaccount" size="45" readonly="readonly" />
      <img src="../images/Search.gif" width="16" height="16" alt="Lookup" id="drsearch" onclick="get1dr()" /></td>
  </tr>
  <tr>
    <td class="boxlabelleft">To Account</td>
    <td colspan="4"><input type="text" name="DRaccount2" id="DRaccount2" size="45" readonly="readonly" />
      <img src="../images/Search.gif" width="16" height="16" alt="Lookup" id="drsearch2" onclick="get1dr2()" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" value="Run" name="run"  onClick="detmultdr()" ></td>
  </tr>
  </table>
  ...
  <div id="drselect" style="position:absolute;visibility:hidden;top:104px;left:455px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      ...
      <tr>
        <td colspan="2"><?php include "selectdr1.php"; ?></td>
      </tr>
    </table>
  </div>
  
  <div id="drselect2" style="position:absolute;visibility:hidden;top:150px;left:455px;height:239px;width:451px;background-color:<?php echo $bgcolor; ?>;border-width:thick thick thick thick; border-color:<?php echo $bghead; ?>; border-style:solid;">
    <table>
      <tr>
        <td><input type="text" id="searchdr2" size="50" onkeypress="doSearchdr2()" /></td>
        <td align="right"><img src="../images/close.png" width="16" height="16" alt="Lookup" id="drclose" onclick="sboxhidedr2()">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><?php include "selectdr2.php"; ?></td>
      </tr>
    </table>
  </div>  
