...
<form name="form1" id="form1" method="post" >
 <input type="hidden" name="savebutton" id="savebutton" value="N">
  <table width="990" border="0" align="center">
    <tr>
      <td colspan="6"><div align="center" class="style1"><u>Add Stock Item </u></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="boxlabelleft"><input type="text" name="stkunit" id="stkunit" size="15"> 
      of 
        <input type="text" name="noinunit" id="noinunit" size="10" value="0"></td>
    ...
    <tr>
      ...
      <td><input type="text" name="avgcost" id="avgcost" readonly value="0"></td>
      <td class="boxlabel">Default Selling Price</td>
      <td colspan="3"><input type="text" name="defsell" id="defsell" value="0"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3"><input type="text" name="barno" id="barno"></td>
    </tr>
    <tr>
      ...
      <td colspan="3"><input type="text" name="supplier" id="supplier" size="45" readonly >
    ...
    <tr>
      ...
      <td><input name="gstkcode" type="text" id="gstkcode"  size="30" maxlength="30" onBlur="checkitemcode(this.value);"></td>
      <td class="boxlabel">Generic Item Description</td>
      <td colspan="3"><input name="gstkname" type="text" id="gstkname"  size="60" maxlength="100"></td>
      </tr>
    <tr>
      <td class="boxlabel">Group</td>
    ...
    <tr>
      <td class="boxlabel">Average Unit Cost</td>
      <td><input type="text" name="gavgcost" id="gavgcost" readonly value="0"></td>
      <td class="boxlabel">Default Selling Price</td>
      <td colspan="3"><input type="text" name="gdefsell" id="gdefsell" value="0"></td>
    </tr>
    <tr>
      <td class="boxlabel">Supplier</td>
      <td colspan="3"><input type="text" name="gsupplier" id="gsupplier" size="45" readonly >
