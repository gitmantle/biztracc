...
$grid->SelectCommand = "select members.member_id,members.lastname,members.firstname,members.preferredname,members.dob,members.checked,comms.area_code,comms.comm from members,comms".$where." group by member_id";
