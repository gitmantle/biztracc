...
$_SESSION['s_module'] = 'infinint_med';
...
$moduledb = 'infinint_med'.$subid.'_'.$coyid;
$_SESSION['s_prcdb'] = $moduledb;
...
<title>Cmeds4U - Chronic Medicine Distribution</title>
...
<div id="wrapper">
	...
	<div id="mainheader">
		<div id="mainlefttop"><img src="../images/jacarandasmall.png" width="83" height="55">  &nbsp;</div>
		<div id="mainrighttop">Select Module : <select onChange="selectpack(this.value)"><?php echo $modules_options; ?></select></div>		
        <div id="maincoyname"><?php echo $coyname; ?>&nbsp;- Distribution Process</div>
        <div id="mainmodule">Process</div>
	</div>
...
<br>
  <div id="tabs">
      <ul>
          <li><a href="#ui-tabs-1">Medicine Distribution</a></li>
      </ul>
      <div id="ui-tabs-1">
