...
$moduledb = 'sal'.$subid.'_'.$coyid;
$_SESSION['s_saldb'] = $moduledb;
...
<div id="wrapper">
	...
	<div id="mainheader">
		<div id="mainlefttop"><img src="../images/lt_logo_sal.png" width="200" height="55">  &nbsp;</div>
...
<br>
  <div id="tabs">
      <ul>
          <li><a href="#ui-tabs-1">Sales Process</a></li>
      </ul>
      <div id="ui-tabs-1">
