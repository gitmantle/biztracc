...
class backup_restore{
    ...
    // Constructor
 	function __construct($dbhost,$database,$dbUser ,$dbPass ,$tables="*", $bkupfile ) {
 	   //let me collect all data before we start	
		$this->host = $dbhost;
	...
	public function backup(){
		...
		$return .= 'DROP TABLE '.$table.';mantle';
  ...
  //yeah its all done
	return "Backup Created Sucsessfully!!";
}
    ...
    //Restore
 	public function restore() {
			...
			foreach ($lines as $line) {				
				...
				//Encounter with DROP Table,but table already dropped.Don't worry countinue.
				 continue;				
				 }
