...
true&&this.p.treeGrid){this.p.data=[];this.p._index={}}},y=function(){var b=c.p.data.length,d,e,f;d=c.p.rownumbers===true?1:0;e=c.p.multiselect===true?1:0;f=c.p.subGrid===true?1:0;d=c.p.keyIndex===false||c.p.loadonce===true?c.p.localReader.id:c.p.colModel[c.p.keyIndex+e+f+d].name;for(e=0;e<b;e++){f=a.jgrid.getAccessor(c.p.data[e],d);c.p._index[f]=e}},A=function(b,d,e,f,g){var h="-1",i="",l,d=d?"display:none;":"",e="ui-widget-content jqgrow ui-row-"+c.p.direction+e,f=a.isFunction(c.p.rowattr)?c.p.rowattr.call(c,
f,g):{};if(!a.isEmptyObject(f)){if(f.hasOwnProperty("id")){b=f.id;delete f.id}if(f.hasOwnProperty("tabindex")){h=f.tabindex;delete f.tabindex}if(f.hasOwnProperty("style")){d=d+f.style;delete f.style}if(f.hasOwnProperty("class")){e=e+(" "+f["class"]);delete f["class"]}try{delete f.role}catch(j){}for(l in f)f.hasOwnProperty(l)&&(i=i+(" "+l+"="+f[l]))}return'<tr role="row" id="'+b+'" tabindex="'+h+'" class="'+e+'"'+(d===""?"":' style="'+d+'"')+i+">"},x=function(b,d,e,f,g){var h=new Date,i=c.p.datatype!=
"local"&&c.p.loadonce||c.p.datatype=="xmlstring",l=c.p.xmlReader,j=c.p.datatype=="local"?"local":"xml";if(i){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(a.isXMLDoc(b)){if(c.p.treeANode===-1&&!c.p.scroll){w.call(c,false,true);e=1}else e=e>1?e:1;var k,n,m=0,p,o=c.p.multiselect===true?1:0,q=c.p.subGrid===true?1:0,C=c.p.rownumbers===true?1:0,u,J=[],x,z={},y,D,B=[],E=c.p.altRows===true?" "+c.p.altclass:"",P;l.repeatitems||(J=v(j));u=c.p.keyIndex===false?a.isFunction(l.id)?l.id.call(c,
...
0;a.isFunction(l.userdata)?c.p.userData=l.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,l.userdata,true).each(function(){c.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,true);(b=a.jgrid.getXmlData(b,l.row,true))||(b=[]);var M=b.length,K=0,N=[],G=parseInt(c.p.rowNum,10);if(M>0&&c.p.page<=0)c.p.page=1;if(b&&M){var H=c.p.scroll?a.jgrid.randId():1;g&&(G=G*(g+1));for(var g=a.isFunction(c.p.afterInsertRow),I=c.p.grouping&&c.p.groupingView.groupCollapse===true;K<M;){y=
b[K];D=j(y,H+K);D=c.p.idPrefix+D;k=e===0?0:e+1;P=(k+K)%2==1?E:"";var ba=B.length;B.push("");C&&B.push(t(0,K,c.p.page,c.p.rowNum));o&&B.push(r(D,C,K));q&&B.push(a(c).jqGrid("addSubGridCell",o+C,K+e));if(l.repeatitems){x||(x=F(o+q+C));var V=a.jgrid.getXmlData(y,l.cell,true);a.each(x,function(a){var b=V[this];if(!b)return false;p=b.textContent||b.text;z[c.p.colModel[a+o+q+C].name]=p;B.push(s(D,p,a+o+q+C,K+e,y))})}else for(k=0;k<J.length;k++){p=a.jgrid.getXmlData(y,J[k]);z[c.p.colModel[k+o+q+C].name]=
p;B.push(s(D,p,k+o+q+C,K+e,y))}B[ba]=A(D,I,P,z,y);B.push("</tr>");if(c.p.grouping){N=a(c).jqGrid("groupingPrepare",B,N,z,K);B=[]}if(i||c.p.treeGrid===true){z._id_=D;c.p.data.push(z);c.p._index[D]=c.p.data.length-1}if(c.p.gridview===false){a("tbody:first",d).append(B.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[D,z,y]);g&&c.p.afterInsertRow.call(c,D,z,y);B=[]}z={};m++;K++;if(m==G)break}}if(c.p.gridview===true){n=c.p.treeANode>-1?c.p.treeANode:0;if(c.p.grouping){a(c).jqGrid("groupingRender",
N,c.p.colModel.length);N=null}else c.p.treeGrid===true&&n>0?a(c.rows[n]).after(B.join("")):a("tbody:first",d).append(B.join(""))}if(c.p.subGrid===true)try{a(c).jqGrid("addSubGrid",o+C)}catch(O){}c.p.totaltime=new Date-h;if(m>0&&c.p.records===0)c.p.records=M;B=null;if(c.p.treeGrid===true)try{a(c).jqGrid("setTreeNode",n+1,m+n+1)}catch(X){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=0;c.p.reccount=m;c.p.treeANode=-1;c.p.userDataOnFooter&&a(c).jqGrid("footerData","set",c.p.userData,true);if(i){c.p.records=
M;c.p.lastpage=Math.ceil(M/G)}f||c.updatepager(false,true);if(i)for(;m<M;){y=b[m];D=j(y,m+H);D=c.p.idPrefix+D;if(l.repeatitems){x||(x=F(o+q+C));var L=a.jgrid.getXmlData(y,l.cell,true);a.each(x,function(a){var b=L[this];if(!b)return false;p=b.textContent||b.text;z[c.p.colModel[a+o+q+C].name]=p})}else for(k=0;k<J.length;k++){p=a.jgrid.getXmlData(y,J[k]);z[c.p.colModel[k+o+q+C].name]=p}z._id_=D;c.p.data.push(z);c.p._index[D]=c.p.data.length-1;z={};m++}}},B=function(b,d,e,f,g){d=new Date;if(b){if(c.p.treeANode===
-1&&!c.p.scroll){w.call(c,false,true);e=1}else e=e>1?e:1;var h,i,l=c.p.datatype!="local"&&c.p.loadonce||c.p.datatype=="jsonstring";if(l){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(c.p.datatype=="local"){h=c.p.localReader;i="local"}else{h=c.p.jsonReader;i="json"}var j=0,k,n,m=[],p,o=c.p.multiselect?1:0,q=c.p.subGrid?1:0,C=c.p.rownumbers===true?1:0,u,J,z={},y,x,D=[],B=c.p.altRows===true?" "+c.p.altclass:"",E;c.p.page=a.jgrid.getAccessor(b,h.page)||0;u=a.jgrid.getAccessor(b,
...
K*(g+1));for(var P=a.isFunction(c.p.afterInsertRow),N=[],G=c.p.grouping&&c.p.groupingView.groupCollapse===true;b<u;){g=J[b];x=a.jgrid.getAccessor(g,i);if(x===void 0){x=M+b;if(m.length===0&&h.cell){k=a.jgrid.getAccessor(g,h.cell);x=k!==void 0?k[i]||x:x}}x=c.p.idPrefix+x;k=e===1?0:e;E=(k+b)%2==1?B:"";var H=D.length;D.push("");C&&D.push(t(0,b,c.p.page,c.p.rowNum));o&&D.push(r(x,C,b));q&&D.push(a(c).jqGrid("addSubGridCell",o+C,b+e));if(h.repeatitems){h.cell&&(g=a.jgrid.getAccessor(g,h.cell));p||(p=F(o+
q+C))}for(n=0;n<p.length;n++){k=a.jgrid.getAccessor(g,p[n]);D.push(s(x,k,n+o+q+C,b+e,g));z[c.p.colModel[n+o+q+C].name]=k}D[H]=A(x,G,E,z,g);D.push("</tr>");if(c.p.grouping){N=a(c).jqGrid("groupingPrepare",D,N,z,b);D=[]}if(l||c.p.treeGrid===true){z._id_=x;c.p.data.push(z);c.p._index[x]=c.p.data.length-1}if(c.p.gridview===false){a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[x,z,g]);P&&c.p.afterInsertRow.call(c,x,z,g);D=[]}z={};j++;b++;if(j==
K)break}if(c.p.gridview===true){y=c.p.treeANode>-1?c.p.treeANode:0;c.p.grouping?a(c).jqGrid("groupingRender",N,c.p.colModel.length):c.p.treeGrid===true&&y>0?a(c.rows[y]).after(D.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join(""))}if(c.p.subGrid===true)try{a(c).jqGrid("addSubGrid",o+C)}catch(I){}c.p.totaltime=new Date-d;if(j>0&&c.p.records===0)c.p.records=u;if(c.p.treeGrid===true)try{a(c).jqGrid("setTreeNode",y+1,j+y+1)}catch(ba){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=
0;c.p.reccount=j;c.p.treeANode=-1;c.p.userDataOnFooter&&a(c).jqGrid("footerData","set",c.p.userData,true);if(l){c.p.records=u;c.p.lastpage=Math.ceil(u/K)}f||c.updatepager(false,true);if(l)for(;j<u&&J[j];){g=J[j];x=a.jgrid.getAccessor(g,i);if(x===void 0){x=M+j;m.length===0&&h.cell&&(x=a.jgrid.getAccessor(g,h.cell)[i]||x)}if(g){x=c.p.idPrefix+x;if(h.repeatitems){h.cell&&(g=a.jgrid.getAccessor(g,h.cell));p||(p=F(o+q+C))}for(n=0;n<p.length;n++){k=a.jgrid.getAccessor(g,p[n]);z[c.p.colModel[n+o+q+C].name]=
k}z._id_=x;c.p.data.push(z);c.p._index[x]=c.p.data.length-1;z={}}j++}}},u=function(){function b(d){var e=0,g,h,i,l,j;if(d.groups!==void 0){(h=d.groups.length&&d.groupOp.toString().toUpperCase()==="OR")&&o.orBegin();for(g=0;g<d.groups.length;g++){e>0&&h&&o.or();try{b(d.groups[g])}catch(k){alert(k)}e++}h&&o.orEnd()}if(d.rules!==void 0){if(e>0){h=o.select();o=a.jgrid.from(h);c.p.ignoreCase&&(o=o.ignoreCase())}try{(i=d.rules.length&&d.groupOp.toString().toUpperCase()==="OR")&&o.orBegin();for(g=0;g<d.rules.length;g++){j=
...
c.p.postData,success:function(e,g,h){if(a.isFunction(c.p.beforeProcessing)&&c.p.beforeProcessing.call(c,e,g,h)===false)Q();else{f==="xml"?x(e,c.grid.bDiv,m,b>1,l):B(e,c.grid.bDiv,m,b>1,l);a(c).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();if(c.p.loadonce||c.p.treeGrid)c.p.datatype="local";b===1&&Q()}},error:function(d,e,f){a.isFunction(c.p.loadError)&&c.p.loadError.call(c,d,e,f);b===1&&Q()},beforeSend:function(b,
d){var e=true;a.isFunction(c.p.loadBeforeSend)&&(e=c.p.loadBeforeSend.call(c,b,d));e===void 0&&(e=true);if(e===false)return false;H()}},a.jgrid.ajaxOptions,c.p.ajaxGridOptions));break;case "xmlstring":H();e=a.jgrid.stringToDoc(c.p.datastr);x(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;Q();break;case "jsonstring":H();e=typeof c.p.datastr=="string"?a.jgrid.parse(c.p.datastr):
c.p.datastr;B(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;Q();break;case "local":case "clientside":H();c.p.datatype="local";e=u();B(e,c.grid.bDiv,m,b>1,l);a(c).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();Q()}}}},I=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?
...
cell:"cell"}},c.p.jsonReader);c.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.localReader);c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=!1,c.p.rowList=[]);c.p.data.length&&y();var L="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",$,S,C,J,M,z,E,N;S=N="";if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=
...
c.p.pager="#"+a(c.p.pager).attr("id"),a(c.p.pager).css({width:e.width+"px"}).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"),R&&a(c.p.pager).hide(),k(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(b){E=a(b.target).closest("tr.jqgrow");a(E).attr("class")!=="ui-subgrid"&&a(E).addClass("ui-state-hover")}).bind("mouseout",function(b){E=a(b.target).closest("tr.jqgrow");a(E).removeClass("ui-state-hover")});var G,T,ca;a(c).before(e.hDiv).click(function(b){z=
b.target;E=a(z,c.rows).closest("tr.jqgrow");if(a(E).length===0||E[0].className.indexOf("ui-state-disabled")>-1||(a(z,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(z).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",[E[0].id,b]);(e=e===false||e==="stop"?false:true)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,E[0].id,b));if(!(z.tagName=="A"||(z.tagName=="INPUT"||z.tagName=="TEXTAREA"||z.tagName=="OPTION"||z.tagName==
"SELECT")&&!d)&&e===true){G=E[0].id;T=a.jgrid.getCellIndex(z);ca=a(z).closest("td,th").html();a(c).triggerHandler("jqGridCellSelect",[G,T,ca,b]);a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,G,T,ca,b);if(c.p.cellEdit===true)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",G,true,b);else{G=E[0].rowIndex;try{a(c).jqGrid("editCell",G,T,true)}catch(f){}}else if(c.p.multikey)if(b[c.p.multikey])a(c).jqGrid("setSelection",G,true,b);else{if(c.p.multiselect&&d){d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+
...
a.jgrid.jqID(d),"#"+a.jgrid.jqID(g))[c.p.useProp?"prop":"attr"]("checked",false)}});c.p.selarrrow=[]}a(c).jqGrid("setSelection",G,true,b)}}}).bind("reloadGrid",function(b,d){if(c.p.treeGrid===true)c.p.datatype=c.p.treedatatype;d&&d.current&&c.grid.selectionPreserver(c);if(c.p.datatype=="local"){a(c).jqGrid("resetSelection");c.p.data.length&&y()}else if(!c.p.treeGrid){c.p.selrow=null;if(c.p.multiselect){c.p.selarrrow=[];I(false)}c.p.savedRow=[]}c.p.scroll&&w.call(c,true,false);if(d&&d.page){var e=
d.page;if(e>c.p.lastpage)e=c.p.lastpage;e<1&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*c.p.rowNum:0}if(c.grid.prevRowHeight&&c.p.scroll){delete c.p.lastpage;c.grid.populateVisible()}else c.grid.populate();c.p._inlinenav===true&&a(c).jqGrid("showAddEditButtons");return false}).dblclick(function(b){z=b.target;E=a(z,c.rows).closest("tr.jqgrow");if(a(E).length!==0){G=E[0].rowIndex;T=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridDblClickRow",[a(E).attr("id"),
G,T,b]);a.isFunction(this.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(E).attr("id"),G,T,b)}}).bind("contextmenu",function(b){z=b.target;E=a(z,c.rows).closest("tr.jqgrow");if(a(E).length!==0){c.p.multiselect||a(c).jqGrid("setSelection",E[0].id,true,b);G=E[0].rowIndex;T=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridRightClickRow",[a(E).attr("id"),G,T,b]);a.isFunction(this.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(E).attr("id"),G,T,b)}});e.bDiv=document.createElement("div");m&&"auto"===
...
a(c).jqGrid("gridDnD","updateDnD");a(c).triggerHandler("jqGridGridComplete");a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=y;c.setHeadCheckBox=I;c.constructTr=A;c.formatter=function(a,b,c,d,e){return o(a,b,c,d,e)};a.extend(e,{populate:O,emptyRows:w});this.grid=e;c.addXmlData=function(a){x(a,c.grid.bDiv)};c.addJSONData=function(a){B(a,c.grid.bDiv)};this.grid.cols=this.rows[0].cells;O();c.p.hiddengrid=!1;a(window).unload(function(){c=
...
break}}else h=g.id;a(b).jqGrid("setSelection",h,!0,d)}if(40===d.keyCode){g=c.nextSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.nextSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(b).jqGrid("setSelection",h,!0,d)}37===d.keyCode&&(b.p.treeGrid&&b.p.data[i][j]&&a(c).find("div.treeclick").trigger("click"),a(b).triggerHandler("jqGridKeyLeft",[b.p.selrow]),a.isFunction(e.onLeftKey)&&e.onLeftKey.call(b,b.p.selrow));39===d.keyCode&&(b.p.treeGrid&&!b.p.data[i][j]&&
a(c).find("div.treeclick").trigger("click"),a(b).triggerHandler("jqGridKeyRight",[b.p.selrow]),a.isFunction(e.onRightKey)&&e.onRightKey.call(b,b.p.selrow))}else 13===d.keyCode?(a(b).triggerHandler("jqGridKeyEnter",[b.p.selrow]),a.isFunction(e.onEnter)&&e.onEnter.call(b,b.p.selrow)):32===d.keyCode&&(a(b).triggerHandler("jqGridKeySpace",[b.p.selrow]),a.isFunction(e.onSpace)&&e.onSpace.call(b,b.p.selrow))})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown")})},getLocalRow:function(a){var e=
!1,b;this.each(function(){"undefined"!==typeof a&&(b=this.p._index[a],0<=b&&(e=this.p.data[b]))});return e}})})(jQuery);
...
d+"</div>":"";e+="</div>";try{"false"==a("#info_dialog").attr("aria-hidden")&&a.jgrid.hideModal("#info_dialog",{jqm:h}),a("#info_dialog").remove()}catch(i){}a.jgrid.createModal({themodal:"info_dialog",modalhead:"info_head",modalcontent:"info_content",scrollelm:"infocnt"},e,c,"","",!0);d&&a.each(c.buttons,function(b){a("#"+a.jgrid.jqID(this.id),"#info_id").bind("click",function(){c.buttons[b].onClick.call(a("#info_dialog"));return!1})});a("#closedialog","#info_id").click(function(){g.hideModal("#info_dialog",
{jqm:h});return!1});a(".fm-button","#info_dialog").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a.isFunction(c.beforeOpen)&&c.beforeOpen();a.jgrid.viewModal("#info_dialog",{onHide:function(a){a.w.hide().remove();a.o&&a.o.remove()},modal:c.modal,jqm:h});a.isFunction(c.afterOpen)&&c.afterOpen();try{a("#info_dialog").focus()}catch(j){}},createEl:function(d,e,b,f,c){function h(b,c){a.isFunction(c.dataInit)&&c.dataInit.call(j,b);c.dataEvents&&
a.each(c.dataEvents,function(){void 0!==this.data?a(b).bind(this.type,this.data,this.fn):a(b).bind(this.type,this.fn)});return c}function g(b,c,d){var e="dataInit,dataEvents,dataUrl,buildSelect,sopt,searchhidden,defaultValue,attr".split(",");"undefined"!=typeof d&&a.isArray(d)&&a.merge(e,d);a.each(c,function(c,d){-1===a.inArray(c,e)&&a(b).attr(c,d)});c.hasOwnProperty("id")||a(b).attr("id",a.jgrid.randId())}var i="",j=this;switch(d){case "textarea":i=document.createElement("textarea");f?e.cols||a(i).css({width:"98%"}):
...
b)),h.append(i);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("<tr></tr>"),g,h,j,s,r="",t;e.append("<td class='first'></td>");var v=a("<td class='columns'></td>");e.append(v);var F=a("<select></select>"),w,y=[];v.append(F);F.bind("change",function(){b.field=a(F).val();j=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===
b.field){s=d.p.columns[g];break}if(s){s.searchoptions.id=a.jgrid.randId();i&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var c=a.jgrid.createEl(s.inputtype,s.searchoptions,"",!0,d.p.ajaxSelectOptions,!0);a(c).addClass("input-elm");h=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===s.searchtype?d.p.stropts:d.p.numopts;var e="",f=0;y=[];a.each(d.p.ops,function(){y.push(this.name)});for(g=0;g<h.length;g++)w=a.inArray(h[g],y),-1!==w&&(0===f&&(b.op=d.p.ops[w].name),
...
c.rows[p]).text():a("td:eq("+r+")",c.rows[p]).html()}if(!k||"&nbsp;"==k||"&#160;"==k||1==k.length&&160==k.charCodeAt(0))k=""}var t=a.extend({},this.editoptions||{},{id:g,name:g}),v=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),A=parseInt(v.rowpos,10)||j+1,u=parseInt(2*(parseInt(v.colpos,10)||1),10);"_empty"==b&&t.defaultValue&&(k=a.isFunction(t.defaultValue)?t.defaultValue.call(l):t.defaultValue);this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));
m=a.jgrid.createEl.call(l,this.edittype,t,k,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));""===k&&"checkbox"==this.edittype&&(k=a(m).attr("offval"));""===k&&"select"==this.edittype&&(k=a("option:eq(0)",m).text());if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData[g]=k;a(m).addClass("FormElement");("text"==this.edittype||"textarea"==this.edittype)&&a(m).addClass("ui-widget-content ui-corner-all");i=a(e).find("tr[rowpos="+A+"]");v.rowabove&&(t=a("<tr><td class='contentinfo' colspan='"+
2*f+"'>"+v.rowcontent+"</td></tr>"),a(e).append(t),t[0].rp=A);0===i.length&&(i=a("<tr "+n+" rowpos='"+A+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(s),a(e).append(i),i[0].rp=A);a("td:eq("+(u-2)+")",i[0]).html("undefined"===typeof v.label?c.p.colNames[r]:v.label);a("td:eq("+(u-1)+")",i[0]).append(v.elmprefix).append(m).append(v.elmsuffix);o[j]=r;j++}});if(0<j&&(r=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
...
d[l.p.id].beforeShowForm:!1,F=a.isFunction(d[l.p.id].afterShowForm)?d[l.p.id].afterShowForm:!1,w=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,y=a.isFunction(d[l.p.id].onInitializeForm)?d[l.p.id].onInitializeForm:!1,A=!0,x=1,B=0,u,H,Q,O,I,o=a.jgrid.jqID(o);"new"===e?(e="_empty",I="add",b.caption=d[l.p.id].addCaption):(b.caption=d[l.p.id].editCaption,I="edit");!0===b.recreateForm&&null!==a("#"+a.jgrid.jqID(t.themodal)).html()&&a("#"+a.jgrid.jqID(t.themodal)).remove();var Y=!0;
b.checkOnUpdate&&b.jqModal&&!b.modal&&(Y=!1);if(null!==a("#"+a.jgrid.jqID(t.themodal)).html()){A=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(o))]);"undefined"==typeof A&&(A=!0);A&&w&&(A=w.call(l,a("#"+o)));if(!1===A)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(b.caption);a("#FormError",r).hide();d[l.p.id].topinfo?(a(".topinfo",r).html(d[l.p.id].topinfo),a(".tinfo",r).show()):a(".tinfo",r).hide();d[l.p.id].bottominfo?(a(".bottominfo",r+"_2").html(d[l.p.id].bottominfo),
...
o+"' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:"+Z+";'></form>").data("disabled",!1),U=a("<table id='"+s+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),A=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+o),I]);"undefined"==typeof A&&(A=!0);A&&w&&(A=w.call(l,a("#"+o)));if(!1===A)return;m();a(l.p.colModel).each(function(){var a=this.formoptions;x=Math.max(x,a?a.colpos||0:0);B=Math.max(B,a?a.rowpos||
0:0)});a(Z).append(U);w=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*x+"'></td></tr>");w[0].rp=0;a(U).append(w);w=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*x+"'>"+d[l.p.id].topinfo+"</td></tr>");w[0].rp=0;a(U).append(w);var A=(w="rtl"==l.p.direction?!0:!1)?"nData":"pData",W=w?"pData":"nData";c(e,l,U,x);var A="<a href='javascript:void(0)' id='"+A+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
a.jgrid.jqID(t.themodal)).hide();a("#"+o).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+o),I]);y&&y.call(l,a("#"+o));"_empty"==e||!d[l.p.id].viewPagerButtons?a("#pData,#nData",r+"_2").hide():a("#pData,#nData",r+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+o),I]);v&&v.call(l,a("#"+o));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",
...
b.closeOnEscape||!0===b.navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(q.modalhead)).focus()},0)}function c(c,d,e,f){for(var g,h,i,j=0,l,k,n=[],m=!1,o="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",p="",s=["integer","number","currency"],r=0,t=0,q,v,y,w=1;w<=f;w++)p+=1==w?o:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
...
v="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<t){var w=[];a.each(a(F)[0].rows,function(a,b){w[a]=b});w.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(w,function(b,c){a("tbody",F).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(k);var y=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,y=!0);p=a("<span></span>").append(p).append("<table border='0' class='EditTable' id='"+n+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+
b.labelswidth+"'>"+(l?s+o:o+s)+"</td><td class='EditButton'>"+v+"</td></tr></tbody></table>");a.jgrid.createModal(q,p,b,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+n+"_2").css("float","right"),a(".EditButton","#"+n+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+n+"_2").hide();p=null;a("#"+q.themodal).keydown(function(c){if(c.which===27){y&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===
...
[d,b,c,e,j]);if(a.isFunction(j.errorfunc))j.errorfunc.call(m,d,b,c,e);else try{a.jgrid.info_dialog(a.jgrid.errors.errcap,'<div class="ui-state-error">'+b.responseText+"</div>",a.jgrid.edit.bClose,{buttonalign:"right"})}catch(f){alert(b.responseText)}j.restoreAfterError===true&&a(m).jqGrid("restoreRow",d,j.afterrestorefunc)}},a.jgrid.ajaxOptions,m.p.ajaxRowOptions||{}))}return k},restoreRow:function(d,e){var b=a.makeArray(arguments).slice(1),f={};"object"===a.type(b[0])?f=b[0]:a.isFunction(e)&&(f.afterrestorefunc=
...
f.p.direction+'">';for(var v=b(o,t,c.groups),y=f.p.colModel,A,x=v.cnt,B=0;B<e;B++){var u="<td "+f.formatCol(B,1,"")+">&#160;</td>",H="{0}";a.each(v.summary,function(){if(this.nm===y[B].name){y[B].summaryTpl&&(H=y[B].summaryTpl);"avg"===this.st.toLowerCase()&&this.v&&0<x&&(this.v/=x);try{A=f.formatter("",this.v,B,this)}catch(b){A=this.v}u="<td "+f.formatCol(B,1,"")+">"+a.jgrid.format(H,A)+"</td>";return!1}});h+=u}h+="</tr>"}l=w}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(d,
e){return this.each(function(){"string"===typeof d&&(d=[d]);var b=this.p.groupingView;this.p.grouping=!0;"undefined"===typeof b.visibiltyOnNextGrouping&&(b.visibiltyOnNextGrouping=[]);var f;for(f=0;f<b.groupField.length;f++)!b.groupColumnShow[f]&&b.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",b.groupField[f]);for(f=0;f<d.length;f++)b.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(d[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,e||{});b.groupField=
d;a(this).trigger("reloadGrid")})},groupingRemove:function(d){return this.each(function(){"undefined"===typeof d&&(d=!0);this.p.grouping=!1;if(!0===d){for(var e=this.p.groupingView,b=0;b<e.groupField.length;b++)!e.groupColumnShow[b]&&e.visibiltyOnNextGrouping[b]&&a(this).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot","#"+a.jgrid.jqID(this.p.id)+" tbody:first").remove();a("tr.jqgrow:hidden","#"+a.jgrid.jqID(this.p.id)+" tbody:first").show()}else a(this).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,
