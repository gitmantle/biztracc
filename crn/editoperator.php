...
$db->query("select operator,address,phone,mobile,email,rate from ".$crndb.".operators where uid = ".$oid);
$row = $db->single();
extract($row);
...
<title>Edit Driver/Operator</title>
...
<div class="container-fluid">
    <section class="container">
		<div class="container-page">				
			<div class="col-md-12">
				<h3 class="dark-grey">Edit Driver/Operator</h3>
				
				<div class="form-group col-sm-4">
					<label>Name</label>
                </div>
                <div class="form-group col-sm-8">
					<input type="text" name="operator" class="form-control" id="operator" value="<?php echo $operator; ?>">
				</div>
                ...
                <div class="form-group col-sm-8">
					<input type="text" name="ad" class="form-control" id="ad" value="<?php echo $address; ?>">
				</div>
                ...
                <div class="form-group col-sm-8">
					<input type="text" name="mob" class="form-control" id="mob" value="<?php echo $mobile; ?>">
				</div>
...
<?php
	...
	if($_REQUEST['savebutton'] == "Y") {
		...
		$db->query("update ".$crndb.".operators set operator = :operator,address = :address,phone = :phone,mobile = :mobile,email = :email,rate = :rate where uid = :id");
