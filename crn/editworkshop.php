...
$rtid = $_REQUEST['uid'];
$q = "select * from workshop where uid = ".$rtid;
$r = mysql_query($q);
...
<form name="form1" id="form1" method="post" >
 ...
 <table width="700" border="0" align="center" cellspacing="6" bgcolor="<?php echo $bgcolor; ?>">
    <tr>
      <td  bgcolor="<?php echo $bghead; ?>" align="center"><label style="color: <?php echo $thfont; ?>"><strong>Edit Workshop </strong></label></td>
    </tr>
    <tr>
      <td colspan="2" class="boxlabelleft"><label style="color: <?php echo $tdfont; ?>">Workshop</label>
        <input name="workshop" type="text" id="workshop" size="100" value="<?php echo $workshop; ?>" ></td>
      </tr>
	<tr>
      <td align="right" >
...
<?php
	...
	if($_REQUEST['savebutton'] == "Y") {
		...
		$q = "update workshop set ";
		$q .= "workshop = '".ucwords($ws)."'";
		$q .= " where uid = ".$rtid;
