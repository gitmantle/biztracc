...
var bmenuItems = [
    ["General","javascript:switchDivm('general','gn');", "", "", "", "", "1", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Details","javascript:switchDivm('details','dt');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
	["People Involved","javascript:switchDivm('people','pe');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Injuries","javascript:switchDivm('injuries','in');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Damage","javascript:switchDivm('damage','dm');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Causes","javascript:switchDivm('causes','cs');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Action Taken","javascript:switchDivm('action','ac');", "", "", "", "", "", "", "", ],
    ["-","", "", "", "", "", "0", "", "", ],
    ["Pictures","javascript:switchDivm('pictures','pc');", "", "", "", "", "2", "", "", ],
];
