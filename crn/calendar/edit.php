...
function getCalendarByRange($id, $crndb){
  //try{
...
if($_GET["id"]){
  $event = getCalendarByRange($_GET["id"], $crndb);
}
?>
  ...
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form action="php/datafeed.php?method=adddetails<?php echo isset($event)?"&id=".$event['uid']:""; ?>" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>                        *Subject:              
            </span>                    
